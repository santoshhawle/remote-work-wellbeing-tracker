---
description: "Prompt for Step 2: Design system architecture from requirements.md and write docs/architecture.md"
---
...
Read `docs/requirements.md` and propose a complete system architecture.
...
3. Write `docs/architecture.md` with Status: Draft.
4. Commit: `git add docs/architecture.md && git commit -m "docs(architecture): propose architecture for <STORY-ID>"`
