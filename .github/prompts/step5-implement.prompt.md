---
description: "Prompt for Step 5: Implement code tasks from impl-plan.md one at a time with tests, lint, and commit per task"
---
...
Read `docs/impl-plan.md`, `docs/architecture.md`, and `docs/requirements.md`. Implement tasks one at a time in dependency order.
...
6. **Update impl-plan.md**: Mark task as ✅ complete.
